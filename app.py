...
st.set_page_config(
    page_title="Laso Invest AB – Tid, Fakturering & Offert",
    page_icon="💼",
    layout="wide",
)
...
DEFAULT_ARTICLES = [
    ...
    },
    {
        "Kategori": "Grävmaskin Volvo 50D",
        "Artikelnr": "25101",
        "Artikel": "Förare grävmaskin",
        "ArtPris": "400.00",
    },
    {
        "Kategori": "Grävmaskin Volvo 50D",
        "Artikelnr": "25102",
        "Artikel": "Rotor encon, grip, centralsmörjning",
        "ArtPris": "160.00",
    },
    {
        "Kategori": "Grävmaskin Volvo 50D",
        "Artikelnr": "25103",
        "Artikel": "Grävskopa 60 cm",
        "ArtPris": "20.00",
    },
    {
        "Kategori": "Grävmaskin Volvo 50D",
        "Artikelnr": "25104",
        "Artikel": "Planeringsskopa 110 cm",
        "ArtPris": "30.00",
    },
    {
        "Kategori": "Grävmaskin Volvo 50D",
        "Artikelnr": "25105",
        "Artikel": "Smalskopa 20 cm",
        "ArtPris": "15.00",
    },
    {
        "Kategori": "Grävmaskin Volvo 50D",
    ...
    },
    {
        "Kategori": "Grävmaskin Volvo 50D",
        "Artikelnr": "25109",
        "Artikel": "Grip och tillsats för kunna dra på rot",
        "ArtPris": "40.00",
    },
    {
        "Kategori": "Grävmaskin Volvo 50D",
        "Artikelnr": "25110",
        "Artikel": "Planeringsbalk med rulle 200 cm",
        "ArtPris": "40.00",
    },
    {
        "Kategori": "Grävmaskin Volvo 50D",
    ...
    },
    {
        "Kategori": "Grävmaskin Volvo 50D",
        "Artikelnr": "25113",
        "Artikel": "Vägrensare, ex mellan vägräcken",
        "ArtPris": "25.00",
    },
    {
        "Kategori": "Grävmaskin Volvo 50D",
        "Artikelnr": "25114",
        "Artikel": "Lång skopa smal",
        "ArtPris": "25.00",
    },
    {
        "Kategori": "Grävmaskin Volvo 50D",
        "Artikelnr": "25115",
        "Artikel": "Buskröjare aggregat 100 cm",
        "ArtPris": "80.00",
    },
    {
        "Kategori": "Grävmaskin Volvo 50D",
        "Artikelnr": "25116",
        "Artikel": "Hydraulisk trädklipp 20 cm",
        "ArtPris": "50.00",
    },
    {
        "Kategori": "Traktor Lundberg 6240",
        "Artikelnr": "25200",
        "Artikel": "Lundberg 6240 inkl förare",
        "ArtPris": "500.00",
    },
    {
        "Kategori": "Traktor Lundberg 6240",
        "Artikelnr": "25201",
        "Artikel": "Förare traktor",
        "ArtPris": "400.00",
    },
    {
        "Kategori": "Traktor Lundberg 6240",
        "Artikelnr": "25202",
        "Artikel": "Planeringsskopa 220 cm bred",
        "ArtPris": "30.00",
    },
    {
        "Kategori": "Traktor Lundberg 6240",
        "Artikelnr": "25203",
        "Artikel": "Pallgafflar, förlängningsgafflar",
        "ArtPris": "30.00",
    },
    {
        "Kategori": "Traktor Lundberg 6240",
        "Artikelnr": "25204",
        "Artikel": "Multiskopa, snö ex vingar 3,60 cm",
        "ArtPris": "60.00",
    },
    {
        "Kategori": "Traktor Lundberg 6240",
        "Artikelnr": "25205",
        "Artikel": "Grip på lastare",
        "ArtPris": "40.00",
    },
    {
        "Kategori": "Traktor Lundberg 6240",
    ...
    },
    {
        "Kategori": "Traktor Lundberg 6240",
        "Artikelnr": "25207",
        "Artikel": "Sandspridare, Drivex, 1,5 kubik 2,5 ton",
        "ArtPris": "40.00",
    },
    {
        "Kategori": "Traktor Lundberg 6240",
        "Artikelnr": "25208",
        "Artikel": "Sandspridare fram skopa 800l",
        "ArtPris": "30.00",
    },
    {
        "Kategori": "Traktor Lundberg 6240",
        "Artikelnr": "25209",
        "Artikel": "1st Hyvelblad, isrivare 260 cm",
        "ArtPris": "40.00",
    },
    {
        "Kategori": "Traktor Lundberg 6240",
        "Artikelnr": "25210",
        "Artikel": "1st hyvel med hjulpar 180cm+",
        "ArtPris": "40.00",
    },
    {
        "Kategori": "Traktor Lundberg 6240",
        "Artikelnr": "25211",
        "Artikel": "Långskopa, bredd 80cm längd 185cm",
        "ArtPris": "25.00",
    },
    {
        "Kategori": "Traktor Lundberg 6240",
        "Artikelnr": "25212",
        "Artikel": "Skopa 2,00 snö, lättare material/matjord",
        "ArtPris": "30.00",
    },
    {
        "Kategori": "Traktor Lundberg 6240",
        "Artikelnr": "25213",
        "Artikel": "Grusfräs 2,00m",
        "ArtPris": "70.00",
    },
    {
        "Kategori": "Traktor Lundberg 6240",
        "Artikelnr": "25214",
        "Artikel": "Hydrauliska pallgafflar 150 längd",
        "ArtPris": "35.00",
    },
    {
        "Kategori": "Traktor Lundberg 6240",
        "Artikelnr": "25215",
        "Artikel": "Hydraulisk slagklippare 200cm bred",
        "ArtPris": "120.00",
    },
    {
        "Kategori": "Övrigt",
        "Artikelnr": "25300",
        "Artikel": "Släp kåpa, tipp",
        "ArtPris": "60.00",
    },
    {
        "Kategori": "Övrigt",
        "Artikelnr": "25301",
        "Artikel": "Avvägningsinstrument Laser",
        "ArtPris": "25.00",
    },
    {
        "Kategori": "Övrigt",
        "Artikelnr": "25302",
        "Artikel": "Instrument för Ledningskoll",
        "ArtPris": "25.00",
    },
    {
        "Kategori": "Övrigt",
        "Artikelnr": "25303",
        "Artikel": "Padda manuell Diesel",
        "ArtPris": "60.00",
    },
    {
        "Kategori": "Övrigt",
        "Artikelnr": "25400",
        "Artikel": "Biggab tippvagn Lastväxlare 7-10ton",
        "ArtPris": "160.00",
    },
    {
        "Kategori": "Övrigt",
        "Artikelnr": "25401",
        "Artikel": "Lastbil / Lastväxlare Entreprenad",
        "ArtPris": "1250.00",
    },
    {
        "Kategori": "Övrigt",
    ...
    },
    {
        "Kategori": "Övrigt",
        "Artikelnr": "25403",
        "Artikel": "Av-etablering",
        "ArtPris": "900.00",
    },
    {
        "Kategori": "Övrigt",
        "Artikelnr": "25404",
        "Artikel": "4-hjuling el, spel",
        "ArtPris": "150.00",
    },
    {
        "Kategori": "Övrigt",
    ...
    },
    {
        "Kategori": "Övrigt",
        "Artikelnr": "25407",
        "Artikel": "Mindre tippvagn",
        "ArtPris": "40.00",
    },
    {
        "Kategori": "Övrigt",
        "Artikelnr": "25500",
        "Artikel": "Maskinist (Hyra av maskin)",
        "ArtPris": "460.00",
    },
    {
        "Kategori": "Övrigt",
    ...
    },
    {
        "Kategori": "Övrigt",
        "Artikelnr": "25502",
        "Artikel": "Resor Bil (per mil)",
        "ArtPris": "60.00",
    },
    {
        "Kategori": "Övrigt",
        "Artikelnr": "25503",
        "Artikel": "Projektledare",
        "ArtPris": "550.00",
    },
    {
        "Kategori": "Övrigt",
...
def format_pris(val):
  try:
    clean_val = (
        str(val).replace("kr", "").replace(" ", "").replace(",", ".").strip()
    )
...
def save_offerter(df):
  df.to_csv(OFFERT_FILE, index=False)
...
def generate_pdf_file(customer_name, records, filepath):
  ...
  header_data = [[
      ...
      Paragraph(
          f"<b>Datum:</b> {date.today().strftime('%Y-%m-%d')}<br/><b>Org.nr/Pers.nr:</b>"
          f" {clean_str(first_rec.get('Kund_OrgNr', ''))}",
          meta_style,
      ),
  ]]
  ...
  k_namn, k_adr = clean_str(first_rec.get("Kund_Namn", "")), clean_str(
      first_rec.get("Kund_Adress", "")
  )
  k_post, k_ort = clean_str(first_rec.get("Kund_Postnr", "")), clean_str(
      first_rec.get("Kund_Ort", "")
  )
  ...
  if k_adr:
    kund_info += f"<br/>{k_adr}"
  if k_post or k_ort:
    kund_info += f"<br/>{k_post} {k_ort}".strip()

  faktura_info = f"<b>FAKTURAADRESS:</b><br/>{f_namn}"
  if f_adr:
    faktura_info += f"<br/>{f_adr}"
  if f_post or f_ort:
    faktura_info += f"<br/>{f_post} {f_ort}".strip()

  address_table = Table(
      [[Paragraph(kund_info, meta_style), Paragraph(faktura_info, meta_style)]],
      colWidths=[9 * cm, 9 * cm],
  )
  ...
  for _, row in records.sort_values(by="Datum").iterrows():
    ...
    beskrivning_text = (
        f"<b>{art_nr_str}{clean_str(row['Artikel'])}</b>{desc}"
    )
  ...
  table_data.append([
      Paragraph("<b>Totalt:</b>", meta_bold),
      Paragraph("", meta_style),
      Paragraph(f"<b>{totalt_timmar} st/h</b>", meta_bold),
      Paragraph("", meta_style),
      Paragraph(f"<b>{totalt_belopp:.2f} kr</b>", meta_bold),
  ])

  t = Table(
      table_data, colWidths=[2.5 * cm, 8.5 * cm, 2.2 * cm, 2.3 * cm, 2.5 * cm]
  )
  t.setStyle(
      TableStyle([
...
def generate_offert_pdf(offertnr, records, filepath):
  ...
  meta_style = ParagraphStyle(
      "MetaText", parent=styles["Normal"], fontSize=9, leading=13
  )
  meta_bold = ParagraphStyle(
      "MetaTextBold",
      parent=styles["Normal"],
  ...
  header_data = [[
      Paragraph(
          "<b>LASO INVEST AB</b><br/><font size=14"
          " color='#2B6CB0'><b>OFFERT</b></font>",
          title_style,
      ),
      Paragraph(
          f"<b>Offertnummer:</b> {offertnr}<br/><b>Datum:</b>"
          f" {first_rec['Offertdatum']}<br/><b>Giltig t.o.m:</b>"
          f" {first_rec['Giltig_Tom']}",
          meta_style,
      ),
  ]]
  ...
  if k_org:
    kund_info += f"<br/>Org.nr/Pers.nr: {k_org}"
  if k_adr:
    kund_info += f"<br/>{k_adr}"
  if k_post or k_ort:
    kund_info += f"<br/>{k_post} {k_ort}".strip()
  ...
  t = Table(
      table_data, colWidths=[1.5 * cm, 9.5 * cm, 2.2 * cm, 2.3 * cm, 2.5 * cm]
  )
  t.setStyle(
      TableStyle([
  ...
  sum_data = [
      [
          Paragraph("Netto exkl. moms:", meta_style),
          Paragraph(f"{totalt_exkl:.2f} kr", meta_style),
      ],
      [
          Paragraph("Moms (25%):", meta_style),
          Paragraph(f"{moms:.2f} kr", meta_style),
      ],
      [
          Paragraph("<b>Totalt att betala:</b>", meta_bold),
          Paragraph(f"<b>{totalt_inkl:.2f} kr</b>", meta_bold),
      ],
  ]
  ...
  villkor_text = (
      "<b>Betalningsvillkor:</b> 30 dagar netto efter slutfört arbete /"
      f" fakturering.<br/>Offerten är giltig t.o.m. <b>{first_rec['Giltig_Tom']}</b>."
  )
...
with tabs[0]:
  ...
  with col_b:
    val_art = st.selectbox(
        "Välj Artikel", options=art_options, index=0, key=f"art_{fc}"
    )
  with col_c:
    antal_val = st.number_input(
        "Antal/Timmar", min_value=1, value=1, step=1, key=f"antal_{fc}"
    )
  with col_d:
  ...
  if st.button("➕ Lägg till rad i underlag"):
    if val_art == "-- Välj artikel --":
      ...
      st.warning(
          "Det där är en kategorirubrik. Välj en artikel under rubriken!"
      )
    else:
  ...
  if st.session_state.temp_items:
    ...
    st.divider()
    if st.button(
        "💾 SPARA HELA UNDERLAGET TILL KUND",
        type="primary",
        use_container_width=True,
    ):
      if not k_namn.strip():
        ...
        if not df_data.empty:
          try:
            start_id = int(pd.to_numeric(df_data["ID"]).max() + 1)
          except Exception:
            start_id = len(df_data) + 1
        ...
        df_data = pd.concat(
            [df_data, pd.DataFrame(new_rows)], ignore_index=True
        )
        save_data(df_data)

        st.session_state.temp_items = []
        st.session_state.form_counter = (
            st.session_state.get("form_counter", 0) + 1
        )
        st.success(
            f"Underlaget för {k_namn} har sparats och formuläret har rensats!"
        )
        st.rerun()
...
with tabs[1]:
  ...
  with sub_tab1:
    ...
    with col_off1:
      ...
      off_k_orgnr = st.text_input(
          "Org.nr / Personnr", key=f"off_k_orgnr_{ofc}"
      )
      off_k_adress = st.text_input("Kund Adress", key=f"off_k_adress_{ofc}")
      col_p, col_o = st.columns(2)
      with col_p:
        off_k_post = st.text_input("Postnr", key=f"off_k_post_{ofc}")
      with col_o:
        off_k_ort = st.text_input("Ort", key=f"off_k_ort_{ofc}")

    with col_off2:
      offert_nr = st.text_input(
          "Offertnummer", value=next_offert_nr, key=f"offert_nr_{ofc}"
      )
      off_datum = st.date_input(
          "Offertdatum", value=date.today(), key=f"off_datum_{ofc}"
      )
      off_giltig = st.date_input(
          "Giltig t.o.m.",
          value=date.today() + timedelta(days=30),
          key=f"off_giltig_{ofc}",
      )
    ...
    with col_oa:
      val_off_art = st.selectbox(
          "Välj Artikel/Tjänst",
          options=art_options_off,
          key=f"val_off_art_{ofc}",
      )
    with col_ob:
      off_antal = st.number_input(
          "Antal/Timmar", min_value=1, value=1, step=1, key=f"off_antal_{ofc}"
      )
    with col_oc:
      off_desc = st.text_input(
          "Beskrivning / Specifikation (Valfri)", key=f"off_desc_{ofc}"
      )

    if st.button("➕ Lägg till rad i offerten"):
      if (
          val_off_art == "-- Välj artikel --"
          or val_off_art.startswith("───")
      ):
    ...
    if st.session_state.temp_offert_items:
      ...
      st.caption(
          "💡 *Ändra Antal direkt i tabellen så räknas Totalt om"
          " automatiskt.*"
      )
      ...
      off_df_temp["Antal"] = (
          pd.to_numeric(off_df_temp["Antal"], errors="coerce")
          .fillna(1)
          .astype(int)
      )
      off_df_temp["A_Pris"] = pd.to_numeric(
          off_df_temp["A_Pris"], errors="coerce"
      ).fillna(0.0)
      ...
      edited_off_df = st.data_editor(
          ...
          column_config={
              ...
              "Antal": st.column_config.NumberColumn(
                  "Antal/Timmar", step=1, format="%d"
              ),
              "A_Pris": st.column_config.NumberColumn(
                  "A-pris", format="%.2f kr"
              ),
              "Totalt": st.column_config.NumberColumn(
                  "Totalt", format="%.2f kr", disabled=True
              ),
          },
      ...
      edited_off_df["Antal"] = (
          pd.to_numeric(edited_off_df["Antal"], errors="coerce")
          .fillna(1)
          .astype(int)
      )
      edited_off_df["A_Pris"] = pd.to_numeric(
          edited_off_df["A_Pris"], errors="coerce"
      ).fillna(0.0)
      edited_off_df["Totalt"] = edited_off_df["Antal"] * edited_off_df["A_Pris"]

      st.session_state.temp_offert_items = edited_off_df.to_dict(
          orient="records"
      )
      ...
      st.divider()
      if st.button(
          "💾 SPARA OCH SKAPA OFFERT", type="primary", use_container_width=True
      ):
        if not off_k_namn.strip():
          ...
          df_offert = pd.concat(
              [df_offert, pd.DataFrame(new_off_rows)], ignore_index=True
          )
          save_offerter(df_offert)

          st.session_state.temp_offert_items = []
          st.session_state.offert_form_counter = (
              st.session_state.get("offert_form_counter", 0) + 1
          )
  ...
  with sub_tab2:
    ...
    if not df_offert.empty:
      valda_offert_nrs = df_offert["Offertnr"].unique()
      valt_offert_nr = st.selectbox(
          "Välj offert att visa / ladda ner PDF:", valda_offert_nrs
      )

      if valt_offert_nr:
        offert_recs = df_offert[df_offert["Offertnr"] == valt_offert_nr]
        st.dataframe(offert_recs, use_container_width=True)

        pdf_path = f"offert_{valt_offert_nr}.pdf"
        if generate_offert_pdf(valt_offert_nr, offert_recs, pdf_path):
          with open(pdf_path, "rb") as pdf_file:
            st.download_button(
                label=f"📄 Ladda ner PDF för Offert {valt_offert_nr}",
                data=pdf_file,
                file_name=f"Offert_{valt_offert_nr}.pdf",
                mime="application/pdf",
                type="primary",
            )
    else:
      st.info("Inga sparade offerter finns ännu.")

# ==========================================
# FLIK 3: ARTIKELDATABAS
# ==========================================
with tabs[2]:
  st.subheader("📦 Artikeldatabas & Prislista")
  st.caption("Ändra direkt i tabellen nedan och klicka på Spara ändringar.")

  edited_art_df = st.data_editor(
      df_art, use_container_width=True, num_rows="dynamic"
  )

  if st.button("💾 Spara ändringar i artikeldatabasen", type="primary"):
    save_articles(edited_art_df)
    st.success("Artikeldatabasen har uppdaterats!")
    st.rerun()

# ==========================================
# FLIK 4: REDIGERA / TA BORT
# ==========================================
with tabs[3]:
  st.subheader("✏️ Hantera sparade arbeten / registreringar")

  if not df_data.empty:
    edited_data_df = st.data_editor(
        df_data, use_container_width=True, num_rows="dynamic"
    )

    if st.button("💾 Spara alla ändringar i registreringar", type="primary"):
      save_data(edited_data_df)
      st.success("Ändringarna har sparats!")
      st.rerun()
  else:
    st.info("Inga registrerade arbeten hittades.")

# ==========================================
# FLIK 5: FAKTURAUNDERLAG & PDF
# ==========================================
with tabs[4]:
  st.subheader("📄 Skapa Fakturaunderlag / Generera PDF")

  if not df_data.empty:
    kunder = list(df_data["Kund_Namn"].unique())
    valdh_kund = st.selectbox("Välj Kund", kunder)

    if valdh_kund:
      kund_df = df_data[df_data["Kund_Namn"] == valdh_kund]
      st.dataframe(kund_df, use_container_width=True)

      pdf_filename = f"fakturaunderlag_{valdh_kund.replace(' ', '_')}.pdf"

      if generate_pdf_file(valdh_kund, kund_df, pdf_filename):
        with open(pdf_filename, "rb") as pdf_f:
          st.download_button(
              label=f"📄 Ladda ner PDF Fakturaunderlag för {valdh_kund}",
              data=pdf_f,
              file_name=f"Fakturaunderlag_{valdh_kund}.pdf",
              mime="application/pdf",
              type="primary",
          )
  else:
    st.info("Ingen data finns registrerad för att skapa underlag.")
